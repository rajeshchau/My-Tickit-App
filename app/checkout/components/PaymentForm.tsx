...
export default function PaymentForm() {
  ...
  const savePayment = useMutation(api.mutations.savePayment); // Initialize the savePayment mutation
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (cardNumber.replace(/\s/g, '').length !== 16) {
      alert("Card number must be exactly 16 digits long."); // Error message
    ...
    await savePayment({
      ...
      cvv,
      expirationDate,
      nameOnCard: 'John Doe', // Replace with actual name input if available
      paymentType,
    });
  };
  ...
  return (
    <Stack spacing={{ xs: 3, sm: 6 }} useFlexGap>
          ...
          <PaymentContainer>
            ...
            >
              <FormGrid sx={{ flexGrow: 1 }}>
                ...
                <OutlinedInput
                    ...
                    // helperText is not a valid prop for OutlinedInput
                  id="card-number"
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              <FormGrid sx={{ flexGrow: 1 }}>
                ...
                <OutlinedInput
                    error={expirationDate.length < 5 && expirationDate.length > 0}
                    // helperText is not a valid prop for OutlinedInput
                  id="card-name"
      ...
      <Button type="submit" variant="contained" color="primary"> {/* Add submit button */}
        Submit Payment
      </Button>
